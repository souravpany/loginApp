...
import com.android.own.loginapp.di.component.DaggerViewHolderComponent
import com.android.own.loginapp.di.component.ViewHolderComponent
...
abstract class BaseItemViewHolder<T : Any, VM : BaseItemViewModel<T>>(
    ...
    private fun buildViewHolderComponent() =
        DaggerViewHolderComponent
            .builder()
            .applicationComponent((itemView.context.applicationContext as LoginApplication).applicationComponent)
